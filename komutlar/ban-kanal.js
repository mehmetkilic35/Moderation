...
exports.run = (client, message, args) => {
	if (!message.guild) return message.author.sendMessage('Bu Komutu Sadece CodAre Sunucusunda Kulanabilirsiniz!');
...
const Embed = new Discord.RichEmbed()
 .setColor('#FFD100')
.setAuthor('PealPlinky Ban Sorgulama', client.user.avatarURL)
